    ...
    return (
        <footer className="pt-20 bg-white z-20" id="contact">
            <div className="container mx-auto mb-24">
                ...
                >
                    <dvi className="flex flex-col flex-1 gap-y-8">
                        {/* logo */}
                        <Link 
                            to={'home'} 
                            smooth={true} 
                    ...
                    {/* Links */}
                    <dvi className="flex-1 flex flex-col xl:items-center">   
                       <div>
                    ...
                    {/* program */}
                    <dvi className='flex-1'>
                        <h3 className="h3 font-bold mb-">Working Hours</h3>
                        <div className="flex flex-col gapy4">
                    ...
                    {/* newsletter */}
                    <dvi className='flex-1'>
                        <h3 className="h3 font-bold mb-">Newsletter</h3>
